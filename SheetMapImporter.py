...
class SheetMapImporter:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'SheetMapImporter_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&SheetMapImporter')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('SheetMapImporter', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/SheetMapImporter/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Import map from Google Spread Sheet'),
            callback=self.run,
